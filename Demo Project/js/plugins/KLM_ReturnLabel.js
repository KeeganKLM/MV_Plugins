 ...
 *                               7. Version History
 * ------------------------------------------------------------------------------
 *   v1.000 - Release on 2019-12-16 at ??:??
 *      > First official release.
 *      
 *   v0.007 - Updated on 2019-12-16 at 13:27
 *      > I'm not doing anything else until this plugin is released.
 *      > Removed a majority of the help section to make plugin simpler
 *      > Plugin Command "LearnNew" now searches for a Label Name and then
 *        adds that label to the ReturnLabelArray without going to the label.
 *      > Just realized that RL Push x acts weird to the line it's called to.
 *      
 *   v0.006 - Updated on 2019-11-09 at 02:27
 *      > How could I have just up and left this thing for so long?!
 *      > Updated the help section quite a bit.
 *         > Removed a lot of unnecessary banter.
 *      
 *   v0.005 - Updated on 2019-06-25 at 22:54
 *      > I decided that I should probably finish making this plugin.
 *      > Made a few small/minor edits with the code.
 *      > Will think about how to rewrite the "Help Page".
 *      > I still want to make the ReturnLabelArray variable per-event.
 *      
 *   v0.004 - Updated on 2019-05-11
 *      > Added plugin-command functionality.
 *      > Haven't tested it yet, though.
 *      
 *   v0.003 - Updated on 2019-05-09 at 00:06
 *      > Improved plugin's description by a lot.
 *      > Also started my attempt to add plugin parameters.
 *      
 *   v0.002 - Updated on 2019-05-07 at 01:52
 *      > First Upload to GitHub. (Mainly as just back-up.)
 *      
 *   v0.001 - Updated on 2019-05-06 at 03:03
 *      > First Draft.
 *      
 *      
 * ------------------------------------------------------------------------------
